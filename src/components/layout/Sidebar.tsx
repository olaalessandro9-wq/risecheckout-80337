...
export function Sidebar() {
  ...
  return (
    <aside
      ...
      className="group/sidebar fixed left-0 top-0 z-50 flex h-screen shrink-0 flex-col border-r border-border/60 bg-background text-foreground transition-all duration-300 ease-in-out"
      style={{
